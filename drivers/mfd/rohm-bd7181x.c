...
struct bd7181x_of_init_data {
	int chip_id;
};

static struct bd7181x_of_init_data bd71815_data __initdata = {
        .chip_id = 0,
};

static struct bd7181x_of_init_data bd71817_data __initdata = {
        .chip_id = 1,
};
...
static struct of_device_id bd7181x_of_match[] = {
	{ .compatible = "rohm,bd71815", .data = &bd71815_data },
	{ .compatible = "rohm,bd71817", .data = &bd71817_data },
	{ },
};
						...
						int *chip_id)
{
	...
	*chip_id  = ((struct bd7181x_of_init_data*)match->data)->chip_id;
 ...
 *  @return 0
 */
static void bd7181x_i2c_remove(struct i2c_client *i2c)
{
